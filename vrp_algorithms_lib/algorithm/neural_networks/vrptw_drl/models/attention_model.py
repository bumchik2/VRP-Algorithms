...
class AttentionModel(ModelBase, nn.Module):
    ...
    def get_locations_information(
        ...
        return torch.tensor(locations_information)
    ...
    def get_vehicles_state_information(
        ...
        for courier_idx in range(len(problem_state.problem_description.couriers)):
            ...
            courier = problem_state.problem_description.couriers[courier_id]
            ...
            normalized_number_of_orders = len(set(vehicle_state.partial_route)) / 50.0
        ...
        return torch.tensor(vehicles_state_information)
    ...
    def initialize(
        ...
        self.graph_embedding = self.attention_neural_network.get_graph_embedding(
